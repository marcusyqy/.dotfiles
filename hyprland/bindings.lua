...
-- hl.unbind("SUPER + SHIFT + B")
-- hl.bind("SUPER + H", "Focus on left window", )
...
o.bind("SUPER + E", "Toggle window floating/tiling", hl.dsp.window.float({ action = "toggle" }))
...
o.bind("SUPER + UP", "Next window in group", hl.dsp.group.next())
o.bind("SUPER + DOWN", "Previous window in group", hl.dsp.group.prev())
...
o.bind("SUPER + BACKSLASH", "Screenshot", "omarchy-capture-screenshot")
o.bind("SUPER + ALT + BACKSLASH", "Screenshot", "omarchy-capture-screenrecording --stop-recording || omarchy-menu toggle trigger.capture.screenrecord")
...
o.bind("SUPER + RIGHT", "Scroll active workspace forward", hl.dsp.focus({ workspace = "e+1" }))
o.bind("SUPER + LEFT", "Scroll active workspace backward", hl.dsp.focus({ workspace = "e-1" }))
