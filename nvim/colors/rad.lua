...
hi("Include", { fg = c.func })
hi("Define", { fg = c.func })
hi("Macro", { fg = c.func })
hi("PreCondit", { fg = c.func })
...
hi("DiagnosticVirtualTextWarn", { fg = c.keyword, bg = bg(c.bg_alt) })
...
hi("DiagnosticUnderlineWarn", { sp = c.keyword, undercurl = true })
...
hi("DiagnosticSignWarn", { fg = c.keyword })
