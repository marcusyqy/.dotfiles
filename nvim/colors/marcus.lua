...
Group.new("Normal", c.superwhite, c.black)
Group.new("LineNr", c.white, c.black)
Group.new("LineNrAbove", c.gray, c.black)
Group.new("LineNrBelow", c.gray, c.black)

Group.new("TabLineFill", c.black, c.blue)
