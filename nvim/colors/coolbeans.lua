...
hi("ErrorMsg", { fg = c.hard_red, bold = true })
...
hi("SpellBad", { sp = c.hard_red, undercurl = true })
...
hi("DiagnosticUnderlineError", { sp = c.hard_red, undercurl = true })
...
hi("DiagnosticSignError", { fg = c.hard_red })
